      ...
      <div className="hero-layout-grid">
        ...
        <div className="hero-text-side">
          ...
          <p className="hero-subtitle" style={{ textAlign: 'left', maxWidth: 'none' }}>
            A state-of-the-art predictive analytics portal. Send digital shopper activity logs into our Databricks-deployed LightGBM ML classifier, inspect engineered session features, and map conversion probabilities in real-time.
          </p>
